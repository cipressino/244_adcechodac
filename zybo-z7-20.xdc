...
##Switches
#set_property -dict {PACKAGE_PIN G15 IOSTANDARD LVCMOS33} [get_ports {sw0}]   ;# sw[0]
...
# set_clock_groups -name grp_50Mhz_96MHz -asynchronous -group [get_clocks clk_fpga_0] -group [get_clocks -of_objects [get_pins design_1_i/clk_wiz_0/inst/mmcm_adv_inst/CLKOUT0]]

# set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ac_bclk_IBUF]

set_clock_groups -name grp_11mhz -asynchronous -group [get_clocks clk_fpga_0] -group [get_clocks -of_objects [get_pins design_1_i/clk_wiz_0/inst/mmcm_adv_inst/CLKOUT0]]
